 ...
 * Back end modules
 */
$GLOBALS['TL_LANG']['MOD']['tl_boxen'] = array('Boxen', 'Zeigt seitenspezifische Inhalte an');


/**
 * Front end modules
 */
$GLOBALS['TL_LANG']['FMD']['tl_boxen'] = array('Boxen', 'Zeigt seitenspezifische Inhalte an');